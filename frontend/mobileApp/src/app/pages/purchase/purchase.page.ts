...
import { ApiService, PurchasePayload, PurchaseRecord } from 'src/app/services/api.service';
...
export class PurchasePage implements OnDestroy {
  ...
  trackByRecordId(_index: number, record: PurchaseRecord): string {
    return record._id;
  }
  ...
  private loadRecords(): void {
    ...
    this.api.getPurchases(token).subscribe({
      next: records => {
