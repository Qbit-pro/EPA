...
export class ApiService {
  ...
  private readonly customBaseUrlKey = 'costtrack_api_base_url';
  ...
  getCustomBaseUrl(): string {
    return this.readCustomBaseUrl();
  }

  setBaseUrl(value: string): string {
    const normalizedUrl = this.normalizeBaseUrl(value);
    localStorage.setItem(this.customBaseUrlKey, normalizedUrl);
    return normalizedUrl;
  }

  clearBaseUrl(): void {
    localStorage.removeItem(this.customBaseUrlKey);
  }
  ...
  private resolveBaseUrl(): string {
    return this.readCustomBaseUrl() || this.resolveDefaultBaseUrl();
  }
  ...
  private readCustomBaseUrl(): string {
    try {
      return localStorage.getItem(this.customBaseUrlKey) || '';
    } catch {
      return '';
    }
  }
